...
const LIVE = [
  ...
  { name: "Botswana", flag: "🇧🇼", count: 114, pending: false },
  { name: "Namibia", flag: "🇳🇦", count: 93, pending: false },
  { name: "DR Congo", flag: "🇨🇩", count: 85, pending: false },
  { name: "Zambia", flag: "🇿🇲", count: 72, pending: false },
  { name: "Mauritius", flag: "🇲🇺", count: 70, pending: false },
  { name: "Madagascar", flag: "🇲🇬", count: 68, pending: false },
  { name: "Eswatini", flag: "🇸🇿", count: 65, pending: false },
  { name: "Malawi", flag: "🇲🇼", count: 62, pending: false },
  { name: "Tanzania", flag: "🇹🇿", count: 61, pending: false },
  { name: "Mozambique", flag: "🇲🇿", count: 59, pending: false },
  { name: "Lesotho", flag: "🇱🇸", count: 57, pending: false },
  { name: "Angola", flag: "🇦🇴", count: 56, pending: false },
  { name: "Brazil", flag: "🇧🇷", count: 35, pending: false },
  { name: "Russia", flag: "🇷🇺", count: 35, pending: false },
  { name: "India", flag: "🇮🇳", count: 35, pending: false },
  { name: "China", flag: "🇨🇳", count: 35, pending: false },
  { name: "Iran", flag: "🇮🇷", count: 35, pending: false },
  { name: "United Arab Emirates", flag: "🇦🇪", count: 35, pending: false },
