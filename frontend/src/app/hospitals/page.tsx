    ...
    <div className="relative">
      ...
      <div className="relative z-10 space-y-6">
        ...
        <div className="flex items-center gap-4 rounded-2xl border border-black/5 bg-white/70 px-5 py-4 shadow-sm backdrop-blur-sm">
          ...
          <div>
            ...
            <div className="text-sm text-gray-500">
              <strong className="text-navy"><AnimatedNumber value={countryTotal} /></strong> hospitals ·{" "}
        ...
        <p className="text-sm text-gray-500">
          Showing <strong className="text-navy">{shownHospitals.length}</strong> of{" "}
        ...
        <div className="grid gap-3 md:grid-cols-2">
          ...
          {shownHospitals.length === 0 && (
            <p className="text-sm text-gray-400">
              {shortlistOnly ? "Your shortlist is empty — tap the ☆ on any card to add one." : "No hospitals match your search."}
            </p>
          )}
        </div>
